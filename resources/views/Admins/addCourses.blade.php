...
@endif
<h2 id="h2">Add new Courses</h2>
<form  method="POST" action="/Admin/addCourses">
    @csrf
    <div>
    <div class="inputs">
        <div class="inp">
        ...
        <div class="inp">
            ...
            <input type="text"  name="shortName" value="{{ old('shortName') }}" required autocomplete="shortName" id="" placeholder="Enter Course shortName">
            @error('shortName')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
    ...
    <div class="inp">
            ...
            <input type="number" name="number_of_years" placeholder="Enter Number of years">
