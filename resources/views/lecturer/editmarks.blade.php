...
<div class="mainDiv">
    <div class="mainmain newClass">
        ...
        <div class="links">
            ...
            <a href="">Students</a>
            <a href="">Attendance</a>
            <a href="" id="active">Marks</a>
            <a href="" id="add" class="addActive">edit marks</a>
        </div>
        <div class="attendance">
            <form action="/marksUpdate" method="post" id="newclass" class="attend">
                @csrf
                <div class="space">
                    <div class="inpDiv">
                    ...
                    <div class="inpDiv">
                        <label for=""><i class="fa-regular fa-calendar"></i><b>Name of exam</b></label>
                            <select name="name" id="">
                                ...
                                <option value="{{$updated->name}}">{{$updated->name}}</option>
                                @endforeach
                            </select>
                    </div>
                </div>
